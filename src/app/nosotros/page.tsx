...
export default async function Nosotros() {
  ...
  return (
    <div className="w-[98vw] flex flex-col items-center">
      ...
      <div className="flex lg:flex-row flex-col mt-20 px-10" >
        ...
        border-b-2 border-[#D20000] p-2 text-center font-black text-gray-700"
          ...
          <Typography
            as="p"
            className="lg:text-2xl text-lg w-fit text-gray-500 mt-5 text-justify font-ligth lg:pr-5 leading-none"
          >
            {uniNosotros.parrafo}
          </Typography>
        </div>
        <div className="lg:w-1/2 w-full lg:h-[65vh] h-[40vh] relative mt-10 lg:mt-0">
