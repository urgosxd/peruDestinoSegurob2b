  ...
  return (
    <footer style={footerStyle}>
      <div style={containerStyle}>
        <p style={textStyle}>© 2024 Tu Compañía. Todos los derechos reservados.</p>
        <nav style={navStyle}>
          <a href="/privacy-policy" style={linkStyle}>Política de Privacidad</a>
          <a href="/terms" style={linkStyle}>Términos de Servicio</a>
