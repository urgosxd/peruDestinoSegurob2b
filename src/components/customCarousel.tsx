          ...
          switch (ele.type) {
            case "Tipo1":
              ...
              return (<div className="relative w-full h-full lg:h-full">
                <Image src={ele.value.photo.url.full_url} layout="responsive" quality={100} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" alt="ims" objectFit="cover" priority={true} fill className=""></Image>
                <motion.div
